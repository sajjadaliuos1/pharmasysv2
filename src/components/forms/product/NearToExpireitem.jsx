...
import { NearToExpire, } from "../../../api/API";

ModuleRegistry.registerModules([
  AllCommunityModule, 
]);

const NearToExpireitem = () => {
  ...
  const getColumnDefs = useCallback(() => {
    return [
      ...
      },
      {
       ...
       {
        headerName: "open strip",
        field: "remainingOpenStrip",
        minWidth: 100,
      },
    ];
  }, []);
  ...
  const fetchInvoiceData = useCallback(async () => {
    ...
    try {
      const response = await NearToExpire();
    ...
    <div className="container mt-2">
      <div className="category-management-container" style={{ padding: '0px', maxWidth: '100%' }}>
        ...
        {screenSize === 'xs' || screenSize === 'sm'}  
         <h4 style={{ marginBottom: '12px' }}>Product Near To Expire</h4>   
...
export default  NearToExpireitem;